...
equation
  ...
  connect(averaged.pin_n_Out, simpleMotor_EMF.pin_n)
    annotation (Line(points={{32,24},{40,24}}, color={0,0,255}));
  connect(simpleMotor_EMF.flange, multiSensorLoad.flange_a)
    annotation (Line(points={{60,30},{72,30}}, color={0,0,0}));
