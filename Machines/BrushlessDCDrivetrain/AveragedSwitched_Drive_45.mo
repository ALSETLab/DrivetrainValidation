...
model AveragedSwitched_Drive_45
  extends DrivetrainValidation.Templates.Basic(
    ...
    redeclare BrushlessDCDrives.Modulation.PWM          modulation,
    redeclare BrushlessDCDrives.Inverter.Switched inverter);
  ...
  Modelica.Mechanics.Rotational.Components.Inertia inertia(
    phi(fixed=true, start=0), J=0.067)
...
equation
  ...
  connect(modulation.y, inverter.u)
  ...
  connect(controller.desiredCurrentIn, dutyCycleIn)
