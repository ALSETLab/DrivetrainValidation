...
record Hacker_Q150_45_4_Sinusoidal
  "(BLDCD) Trap: Hacker Q-150-45-4, 12 kWatt"
  import Modelica.Constants.pi;
  extends BrushlessDCDrives.Machines.Records.Base.Sinusoidal(
    p=2 "pole pairs",
    Rt=0.0155,
    ...
    tau_nom=23.853,
    w_nom=Modelica.Units.Conversions.from_rpm(3365),
...
end Hacker_Q150_45_4_Sinusoidal;
