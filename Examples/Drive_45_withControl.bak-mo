...
model Drive_45_withControl
  extends DrivetrainValidation.Templates.Basic(
    ...
    redeclare BrushlessDCDrives.Controller.Current      controller(
...
equation
  ...
  connect(inverter.rotateCW, modulation.rotateCW)
    annotation (Line(points={{-2,0},{-19,0}}, color={255,0,255}));
  connect(modulation.rotateCW_In, controller.rotateCW_Out)
    annotation (Line(points={{-42,0},{-59,0}}, color={255,0,255}));
