...
model SimplifiedMotor
  ...
  FMU.Thermal.SimplifiedDrive_L simplifiedDrive_L1
...
equation
  ...
  connect(drive_45_FMU1.rotateCW_In1, trapezoidal.rotateCW_In1) annotation (
      Line(points={{120,38},{86,38},{86,46},{54,46},{54,67},{120,67}}, color={
          255,0,255}));
  connect(simplifiedDrive_L1.omega, trapezoidal.speed) annotation (Line(points=
          {{120,20},{112,20},{112,22},{110,22},{110,44},{90,44},{90,72},{120,72},
          {120,72.25}}, color={0,0,127}));
  connect(simplifiedDrive_L1.rotationCW, trapezoidal.rotateCW_In1) annotation (
      Line(points={{120,16},{106,16},{106,38},{86,38},{86,46},{54,46},{54,67},{
          120,67}}, color={255,0,255}));
  ...
  connect(realExpression.y, simplifiedDrive_L1.tau) annotation (Line(points={{
          27,20},{104,20},{104,10},{119.8,10}}, color={0,0,127}));
  connect(drive_45_FMU1.tau, simplifiedDrive_L1.tau) annotation (Line(points={{
          120,32},{98,32},{98,20},{104,20},{104,10},{119.8,10}}, color={0,0,127}));
